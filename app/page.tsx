...
function RichEditor({ value, onChange, multiline, placeholder, allowTable, notify }: { value: string; onChange: (v: string) => void; multiline?: boolean; placeholder?: string; allowTable?: boolean; notify: (s: string) => void }) {
  ...
  return <div className="richEditor"><div className="richToolbar">
    ...
    {multiline && <select className="highlightSelect" defaultValue="" aria-label="Highlight color" onMouseDown={e=>e.stopPropagation()} onChange={e=>{if(e.target.value){changeHighlight(e.target.value);e.currentTarget.value=''}}}><option value="">Highlight</option><option value="#fff19a">Yellow</option><option value="#b7f7c0">Green</option><option value="#ffb3b3">Red</option></select>}

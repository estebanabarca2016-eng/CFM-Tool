...
const initialCustomers: Customer[] = [
  { id: 1, name: 'Ahold', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 2, name: 'Air Product', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 3, name: 'Alticor', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 4, name: 'Aramark', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 5, name: 'Barrick Gold', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 6, name: 'Brasfield & Gorrie', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 7, name: 'CVS Health', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 8, name: 'Eaton', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 9, name: 'Eli Lilly', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 10, name: 'EMC Corporation', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 11, name: 'Encompass', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 12, name: 'Fanatics', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 13, name: 'Fed Ex', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 14, name: 'FG Aviation', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 15, name: 'First Data', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 16, name: 'Honeywell', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 17, name: 'Humana', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 18, name: 'Indianapolis Colts', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 19, name: 'International Paper', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 20, name: 'Johnson & Johnson', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 21, name: 'Liberty Global', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 22, name: 'Lilac Communications', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 23, name: 'M Automotive', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 24, name: 'MGM Resorts', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 25, name: 'MP Air', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 26, name: 'MSG Aviation', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 27, name: 'Nissan', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 28, name: 'Pfizer', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 29, name: 'ROP Aviation', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 30, name: 'Sedgwick', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 31, name: 'SMGM', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 32, name: 'Starr Equipment', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 33, name: 'Swagelok', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 34, name: 'T-Mobile', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 35, name: 'UHC', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 36, name: 'Whirlpool', rule: 'Not configured', includeTripNumber: false, homeBase: '' },
  { id: 37, name: 'Zimmer', rule: 'Not configured', includeTripNumber: false, homeBase: '' }
]

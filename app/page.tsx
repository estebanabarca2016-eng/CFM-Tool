...
function ScheduleProcessor({ schedule, setSchedule, notify, deals, customers, aircraft, templates, contacts, setGeneratedEmails, setPage }: { schedule: string; setSchedule: (s: string) => void; notify: (s: string) => void; deals: Deal[]; customers: Customer[]; aircraft: Aircraft[]; templates: Template[]; contacts: Contact[]; setGeneratedEmails: (e: Email[]) => void; setPage: (p: Page) => void }) {
  const sample='27183\t4/04\t19:00\tN838C\tKRUQ\tSALISBURY, NC\tKJFK\tNEW YORK, NY\t75\tGP  / CM\t4/04\t20:27\t1\tAhold\tAndres\tSalisbury Corporate Hangar\t4/3/2026\n27183\t4/04\t22:35\tN838C\tKJFK\tNEW YORK, NY\tKOPF\tMIAMI\t86\tGP  / CM\t4/05\t00:13\t2\tAhold\tAndres\tMODERN AVIATION\t4/3/2026\n27183\t4/05\t10:35\tN838C\tKOPF\tMIAMI\tKRUQ\tSALISBURY, NC\t86\tGP  / CM\t4/05\t00:13\t2\tAhold\tAndres\tFONTAINEBLEAU AVIATION\t4/3/2026'
